...
fig3 <- cor(dat3, use = "complete.obs")

ggcorrplot(fig3, title = "Correlations")

ggcorrplot(fig3, type = "lower", 
           title = "Correlations", 
           ggtheme = theme_gdocs())
...
```{r problem_4,echo=FALSE, results='hide', fig.keep='last'}
...
```{r problem_5,echo=FALSE, results= 'hide', fig.keep='last'}

ggplot(dat5, aes(x = reorder(names, var1), y = var1))+
      geom_point(color = "dark green")+
      geom_segment(aes(x=, xend=names ,y=0,yend=var1), colour = "dark green")+
...
```{r problem_6,echo=FALSE, results='hide', fig.keep='last'}
...
```{r,problem_7,echo=FALSE,message=FALSE, results='hide', fig.keep='last'}   

ggplot(books_checked_out2, aes(y = Genre,
                               x = Time1,
                               xend = Time5))+ geom_dumbbell()
...
```{r, problem_8,echo=FALSE, results='hide', fig.keep='last'}
